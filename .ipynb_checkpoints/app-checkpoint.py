...
def recommend(book_name):
    ...
    # Lets create empty list and in that list I want to populate with the book information
...
#import data
books = pd.read_csv('Data/books1.csv') # books data
users = pd.read_csv('Data/users3.csv') # user and age data
ratings = pd.read_csv('Data/ratings2.csv') # users rating data 
